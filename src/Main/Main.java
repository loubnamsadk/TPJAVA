...
import Controlleurs.Controlleurdepartement;
...
public class Main {
    ...
    public static void showPrincipalMenu(){
        ...
        switch(option) {
            case 1:
               Controlleurdepartement.AfficherMenu();
                break;
            case 2:
                break;
            case 3:
    ...
    public static void main(String[] args) {
        ...
        Enseigant enseignant = new Enseigant();
        enseignant.setNom("Msadk");
        enseignant.setPrenom("Loubna");
        enseignant.setEmail("loubna@gmail.com");
        enseignant.setGrade("SUP");
        enseignant.setId(Basedonne.getEnsId());
       Basedonne.enseignants.add(enseignant);
        showPrincipalMenu();
    }
}